...
### Enhancements
- 4 orchestration skills (discuss, plan, review, work) show "Recommended: Sonnet or above" in autocomplete description
- Decision docs 018-020 committed (TL constraints, L2 test-plugin, Doodlestein pipeline)
- Stale pipeline state fixed for discussions 004, 026

### Component Counts
- 19 skills, 17 agents, 2 MCP servers, 2 hooks

...
async function callGeminiSDK(model, history, systemPrompt) {
    ...
    if (text == null || text === "") {
        ...
        throw new Error("Gemini returned no text (empty candidates or blocked by safety filters).");
    }
    return text;
}
// --- Session Management ---
...
server.registerTool("reply", {
    ...
    try {
        ...
        const responseText = await callGemini(useModel, nextHistory, session.systemPrompt);

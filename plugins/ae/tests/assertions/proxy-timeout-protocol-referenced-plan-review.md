...
### MUST
- SKILL.md MUST contain text referencing Proxy Timeout Protocol from Agent Selection Reference — exact wording at Step 1 Cross-family: "Apply **Proxy Timeout Protocol** from Agent Selection Reference — on proxy failure, TL handles angle-aware fallback."

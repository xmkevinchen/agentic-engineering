---
id: proxy-timeout-protocol-referenced-consensus
target: ae:consensus
layer: 1
source: generated
---
...
- MUST NOT define custom fallback logic (e.g., inline retry rules) that duplicates or contradicts the Agent Selection Reference protocol
